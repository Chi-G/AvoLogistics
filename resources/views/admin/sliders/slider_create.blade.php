                            ...
                            <div class="table-responsive mb-4 mt-4">
                                <form action="{{ route('admin.sliders.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="text" name="title" class="form-control" id="sliderTitle" value="{{ old('title') }}" required>
                                        @error('title')
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <textarea name="description" class="form-control" id="sliderDescription" rows="3" required>{{ old('description') }}</textarea>
                                        @error('description')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group mb-4 mt-3">
                                        ...
                                        <input type="file" name="image" class="form-control-file" id="sliderImage" required>
                                        @error('image')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <button type="submit" class="mt-4 mb-4 btn btn-primary">Create Slider</button>
                                </form>
                            </div>
                        </div>
                        </div>
