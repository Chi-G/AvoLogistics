                                ...
                                <table id="sliders-table" class="table table-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        @foreach ($news as $item)
                                            <tr>
                                                <td>{{ $item->blog_bg_title }}</td>
                                                <td>{{ $item->blog_bg_desc }}</td>
                                                <td><img src="{{ asset('storage/' . $item->image_sm) }}" alt="{{ $item->blog_title }}" width="100"></td>
                                                <td>{{ $item->blog_title }}</td>
                                                <td>{{ $item->blog_short_desc }}</td>
                                                <td><img src="{{ asset('storage/' . $item->image_bg) }}" alt="{{ $item->blog_title }}" width="100"></td>
                                                <td>{{ $item->blog_long_desc1 }}</td>
                                                <td>{{ $item->blog_long_desc2 }}</td>
                                                <td>{{ $item->blog_snippet }}</td>
                                                ...
                                                <td class="text-center">
                                                    <div class="dropdown custom-dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                                            ...
                                                            <a class="dropdown-item" href="#" onclick="deleteSlider({{ $item->id }})">Delete</a>
                                                        </div>
                                                    </div>
