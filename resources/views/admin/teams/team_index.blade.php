                                    ...
                                    <tbody>
                                        @foreach($teams as $team)
                                            <tr>
                                                ...
                                                <td><img src="{{ asset('storage/' . $team->image) }}" alt="{{ $team->name }}" width="100"></td>
                                                <td><a href="{{ $team->fb }}" target="_blank">{{ $team->fb }}</a></td>
                                                <td><a href="{{ $team->linkedIn }}" target="_blank">{{ $team->linkedIn }}</a></td>
                                                <td><a href="{{ $team->twitter }}" target="_blank">{{ $team->twitter }}</a></td>
                                                <td><a href="{{ $team->IG }}" target="_blank">{{ $team->IG }}</a></td>
                                                ...
                                                <td class="text-center">
                                                    <div class="dropdown custom-dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                                            <a class="dropdown-item" href="{{ route('admin.sliders.edit', $team->id) }}">Edit</a>
                                                            <a class="dropdown-item" href="#" onclick="deleteSlider({{ $team->id }})">Delete</a>
                                                        </div>
                                                    </div>
