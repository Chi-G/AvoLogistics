                                ...
                                <table id="sliders-table" class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Service Details Title</th>
                                            <th>Service Details Background Description</th>
                                            <th>Image</th>
                                            <th>Date</th>
                                            <th>Actions</th>
                                        </tr>
                                    ...
                                    <tbody>
                                        @foreach($services as $service)
                                            <tr>
                                                <td>{{ $service->service_title1 }}</td>
                                                <td>{{ $service->service_title2 }}</td>
                                                <td>{{ $service->service_title3 }}</td>
                                                <td>{{ $service->service_title4 }}</td>
                                                <td>{{ $service->service_desc1 }}</td>
                                                <td>{{ $service->service_desc2 }}</td>
                                                <td>{{ $service->service_desc3 }}</td>
                                                <td>{{ $service->service_desc4 }}</td>
                                                <td>{{ $service->offer_bg_title }}</td>
                                                <td>{{ $service->offer_title1 }}</td>
                                                <td>{{ $service->offer_title2 }}</td>
                                                <td>{{ $service->offer_title3 }}</td>
                                                <td>{{ $service->offer_desc1 }}</td>
                                                <td>{{ $service->offer_desc2 }}</td>
                                                ...
                                                <td class="text-center">
                                                    <div class="dropdown custom-dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                                            ...
                                                            <a class="dropdown-item" href="#" onclick="deleteSlider({{ $service->id }})">Delete</a>
                                                        </div>
                                                    </div>
