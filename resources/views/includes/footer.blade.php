        ...
        <div class="row align-items-center">
            <div class="col-lg-5">
                <div class="single-widget-bottom">
                    <ul>
                        <li>
                            <a href="https://templates.envytheme.com/prevoz/default/terms.html">Terms & Conditions</a>
                        </li>
                        <li>
                            <a href="https://templates.envytheme.com/prevoz/default/privacy.html">Privacy &Policy</a>
                        </li>
                    </ul>
                </div>
            </div>
